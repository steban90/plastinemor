...
<html>
    ...
    <body>
        ...
        <div id="plasti-slider-container">
            ...
            <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 600px; height: 500px; overflow: hidden; visibility: hidden;">
                ...
                <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
                    ...
                    <div style="position:absolute;display:block;background:url('resources/img/slider-img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
                </div>
                <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 500px; overflow: hidden;">

                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c6.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c0.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c1.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c2.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c3.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c4.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c5.png" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c7.jpg" />
                    </div>
                    <div style="display: none;">
                        <img data-u="image" src="resources/img/slider-img/c8.png" />
                    </div>
        ...
        <script src="resources/js/jssor-slider.js" type="text/javascript"></script>
    </body>
</html>
